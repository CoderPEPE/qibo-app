    ...
    return (
      <View>
        <View style={styles.mainView}>
          <Text style={styles.welcomeWord}>Welcome to Qibo</Text>
    ...
    return (
      ...
      >
        <View style={{ flexDirection: "row" }}>
          ...
          >
            <Text style={{ ...Fonts.whiteColor15Bold }}>SignUp</Text>
          </TouchableOpacity>
        </View>
      </View>
    );
  ...
  function orIndicator() {
    return (
      <View style={styles.orWrapStyle}>
        <View style={{ flex: 1, backgroundColor: "#E5E7EB", height: 1.5 }} />
        <Text
          style={{
  ...
  function registerButton() {
    return (
      <TouchableOpacity
        ...
        onPress={() => navigation.push("Signup")}
      >
        <Text style={{ ...Fonts.textGreenColor15SemiBold }}>Register</Text>
      </TouchableOpacity>
    );
  }
