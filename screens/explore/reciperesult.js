                ...
                <View style={styles.descriptionContainer}>
                    <ScrollView style={styles.descriptionScrollContent}>
                        <Text style={styles.descriptionContent}>
                            ...
                            Note: This recipe is inspired by the provided ingredients to
                            create a dish that reflects the principles of balance and
                            well-being in Chinese medicine. It does not directly contain the
                            three mentioned ingredients, given their unconventional nature as
                            foods.{"\n\n"}
                            ...
                            {"\u2022 "}A pinch of sea salt{"\n"}
                            {"\u2022 "}Optional: a drop of artemisia (Ai Ye) essential oil,
                            ensuring it's food-grade{"\n\n"}
                            <Text style={styles.boldText}>Preparation:{"\n"}</Text>
                            1. Prepare the salad: In a large bowl, combine spinach, soybean
                            sprouts, carrot, cucumber, and nuts.{"\n"}
                            2. Make the dressing: In a small bowl, mix sesame oil, rice
                            vinegar, honey, grated ginger, and sea salt. If available and safe
                            for culinary use, add a drop of artemisia essential oil.{"\n"}
                            3. Combine: Pour the dressing over the salad and mix well to
                            ensure the vegetables are fully coated.{"\n"}
                            4. Serve: Transfer the salad onto plates and garnish with sesame
                            seeds.
                        </Text>
                    </ScrollView>
                </View>
        ...
        return (
            <View style={styles.headerWrapStyle}>
                ...
                <View style={styles.helloContainer}>
                    <Text style={{ marginTop: -15, ...Fonts.blackColor24ExtraBold }}>
                        Recipes
                    </Text>
                </View>
